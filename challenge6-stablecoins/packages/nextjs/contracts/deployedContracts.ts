...
const deployedContracts = {
  ...
  11155111: {
    DEX: {
      address: "0xa320D9EDaBF48EFdeF4f81ed65A4efc06924b2E2",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9956752,
    },
    MyUSD: {
      address: "0x17b750131CdEe7e1BFa5Fc8a43D5a092FEd93049",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9956751,
    },
    MyUSDEngine: {
      address: "0xf2A4Ac9B1BbA9cAd7f717fa8B4b50B1013b8823b",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9956755,
    },
    MyUSDStaking: {
      address: "0x0933C57646473438CadB85008Cc103837A867BAc",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9956754,
    },
    Oracle: {
      address: "0x0f96EB41802250725722271222Af864C24C4898F",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9956753,
    },
    RateController: {
      address: "0x966Cdae2d94626AAbd207E1f17d5D2c57353Cd57",
      abi: [
        {
          inputs: [
            {
