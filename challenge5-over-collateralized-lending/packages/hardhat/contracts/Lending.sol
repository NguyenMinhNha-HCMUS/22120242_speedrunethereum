...
contract Lending is Ownable {
    ...
    function withdrawCollateral(uint256 amount) public {
        ...
        if (s_userBorrowed[msg.sender] > 0) {
            _validatePosition(msg.sender); // Nếu sau khi rút, tỷ lệ < 120%, hàm này sẽ revert toàn bộ giao dịch
        }
    ...
    function isLiquidatable(address user) public view returns (bool) {
        ...
        return (positionRatio * 100) < COLLATERAL_RATIO * 1e18; // Check if position is unsafer);
    }
    ...
    function liquidate(address user) public {
        ...
        uint256 collateralPurchased = (userDebt * userCollateral) / collateralValue; //tính giàn tiếp tốn ít gas hơn gọi orcale DEX
